...
> This document describes the classic execution engine. See
> `docs/cinematic-v2/ARCHITECTURE.md` for the source-first multi-track engine.
> Project workflow state and execution engine are separate dimensions.
