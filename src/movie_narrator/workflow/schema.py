...
class JobParams(BaseModel):
    ...
    # Editable delivery package (WAV stems + backend-neutral timeline)
    edit_package_export: Optional[bool] = None
    # Optional separately supplied source-audio file. A file path alone does
    # not prove dialogue provenance, so verification is an explicit flag.
    original_audio_path: Optional[str] = None
    original_audio_verified: Optional[bool] = None
