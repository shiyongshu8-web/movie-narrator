...
``settings.tts_provider`` ("edge" / "openai" / "mimo" / "zhipu" / "minimax"). Each language maps
to a provider-native voice id:
  ...
  - zhipu → 智谱 GLM-TTS voice id (e.g. "tongtong")
  - minimax → MiniMax account/system voice id (e.g. "Chinese (Mandarin)_Reliable_Executive")
"""
...
SUPPORTED_PROVIDERS: tuple[str, ...] = ("edge", "openai", "mimo", "zhipu", "minimax")
